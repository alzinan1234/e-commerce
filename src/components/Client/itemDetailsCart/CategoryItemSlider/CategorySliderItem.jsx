...
export const CategorySliderItem = () => {
  ...
  return (
    <div clasName="">
      <div className="maxWidth mx-auto pt-10 ">
        <HeadingText title={"Same Products"} />
      </div>

      <div className="category-all-item mt-8 pb-10">
        <CategoryItemSlider CategoryItem={CategoryItem} />
      </div>
    </div>
  );
};
